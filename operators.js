// JS operators are symbols or keyword used to perform the operations on values and variables
// types of operators 
// 1) arithmetic operators (+, -, *, /, %)
console.log(5+3);
console.log(5-3);

// 2) assignment operators (=, +=, -=, *=, /=) - used to assign value of operator
let n = 10;
n+=5;
n*=2;
console.log(n);
...
// 4) logical operators (determine the equality and difference between the value) --> Truth table ke basis pe output nikaal lena
...
// 10) Bigint operators
const big1 = 1234384834837843n; // with the help of bigint operators you can only do addition, subtraction and multiplication. No division
